        ...
        <Grid container spacing={0} sx={{ flexDirection: { xs: 'column', md: 'unset' } }}>
          ...
          <Grid item xs={12} md={5} sx={{ position: 'relative' }}>
            ...
            >
              ...
              >
                <img src="/images/certificate.png" alt="Certificate icon" width={50} height={50} quality={97} />
              </Box>
              <Box>
                <Typography
                  component="h6"
            ...
            <Box sx={{ lineHeight: 0 }}>
              <img src="/images/home-hero.jpg" width={487.3} height={487.3} alt="Hero img" />
            </Box>
          </Grid>
        </Grid>

        {/* Experience */}
        <Box sx={{ boxShadow: "10", py: 4, px: 7, borderRadius: 4 }}>

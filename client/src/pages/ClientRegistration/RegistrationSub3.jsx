      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6}>
          <Typography variant="h6" gutterBottom sx={{ mt: 2 }}>
            ...
            {validCertificateFile?<CheckCircleIcon color="primary"/>:<UnpublishedIcon  sx={{ color: red[500] }}/>}
          </Typography>
        </Grid>
        <Grid item container direction="column" xs={12} sm={6}>
          <Typography variant="h6" gutterBottom sx={{ mt: 2 }}>
            Logo Uploaded
            {logoFile?<CheckCircleIcon color="primary"  />:<UnpublishedIcon  sx={{ color: red[500] }}/>}
          </Typography>
